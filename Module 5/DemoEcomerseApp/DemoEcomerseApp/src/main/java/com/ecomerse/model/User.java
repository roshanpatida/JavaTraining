...
public class User {
	...
	@OneToMany(mappedBy = "user",cascade = CascadeType.ALL) // all address will be automatically deleted when we delete the user. 
	private List<Address> address = new ArrayList<>();
	
	@Embedded
	@ElementCollection // seperate table created
